...
**Issues and questions are very welcome.** If you find something wrong in the contract, in the
tests, or in a claim this repository makes, please open an issue — including "your README says X
and the code does Y", which is the most useful kind.
